...
data = session.read.json("../datasets/sample_rdt.json")
data_rdd = data.rdd
...
# Find the worst comments from the list of worst comments (topWorstUserComment)
...
#print(subComments)
#print(str(bestCommentsByUser.collect()))
#print(topBestUserComments)
#print(str(worstCommentsByUser.collect()))
#print(topWorstUserComments)
#print(topAverage)
#print(bottomAverage)
